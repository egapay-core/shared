...
var File_eganow_api_payment_common_proto protoreflect.FileDescriptor

var file_eganow_api_payment_common_proto_rawDesc = []byte{
...
var (
	file_eganow_api_payment_common_proto_rawDescOnce sync.Once
	file_eganow_api_payment_common_proto_rawDescData = file_eganow_api_payment_common_proto_rawDesc
)

func file_eganow_api_payment_common_proto_rawDescGZIP() []byte {
	file_eganow_api_payment_common_proto_rawDescOnce.Do(func() {
		file_eganow_api_payment_common_proto_rawDescData = protoimpl.X.CompressGZIP(file_eganow_api_payment_common_proto_rawDescData)
	})
	return file_eganow_api_payment_common_proto_rawDescData
}
...
func init() { file_eganow_api_payment_common_proto_init() }
func file_eganow_api_payment_common_proto_init() {
	if File_eganow_api_payment_common_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_eganow_api_payment_common_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_eganow_api_payment_common_proto_goTypes,
		DependencyIndexes: file_eganow_api_payment_common_proto_depIdxs,
		MessageInfos:      file_eganow_api_payment_common_proto_msgTypes,
	}.Build()
	File_eganow_api_payment_common_proto = out.File
	file_eganow_api_payment_common_proto_rawDesc = nil
	file_eganow_api_payment_common_proto_goTypes = nil
	file_eganow_api_payment_common_proto_depIdxs = nil
}
